...
if (isset($_POST['submit'])) {
    ...
    $q = "update `classes` set `class_name`='$class_name' where `id`='$id'";
    $result = mysqli_query($conn,$q);
    if($result > 0){
                ...
                <div class="col-lg-12 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                    <form method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" name="class_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $data['class_name']; ?>">
