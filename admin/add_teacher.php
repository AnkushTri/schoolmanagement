                ...
                <div class="col-lg-12 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="contact" class="form-control" id="exampleInputContact" aria-describedby="emailHelp">

                        </div>
                        <div class="mb-3">
                            <label for="exampleInputQualification" class="form-label">Qualification</label>
                            <input type="text" name="qualification" class="form-control" id="exampleInputQualification" aria-describedby="emailHelp">

                        </div>
                        <div class="mb-3">
                            <label for="exampleInputExperience" class="form-label">Experience</label>
                            <input type="text" name="experience" class="form-control" id="exampleInputExperience" aria-describedby="emailHelp">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="dob" class="form-control" id="exampleInputDOB" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
